...
{
	typename iterator_traits<InputIterator>::value_type r{};	// chiamiamo esplcitamente il costruttore di default con la sintassi di C++14 (perch� MSVS non supporta pi� il vanilla)
